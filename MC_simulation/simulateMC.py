...
if __name__ == '__main__':
    ...
    num_episodes = 100 # number of initial positions to attempt for a given noise parameter set
            ...
            for i in range(num_episodes):
                ...
                for t in range(T):
                    ...
                    if control_type == "nn":
                        ...
                        action = action_space_env[pi[(state_ind, t)]]
